...
def erb_space(low_freq=80, high_freq=5000, n=64):
    ear_q = 9.26449
    min_bw = 24.7
...
def  MRCG(wav_data,sr):   
    cochleagram1 = cochleagram_extractor(wav_data, sr, 320, 160, 64, None)
    #print(cochleagram1)
    #plt.imshow(np.sqrt(np.flipud(cochleagram1)))
    #plt.show()
    
    cochleagram2=get_avg(cochleagram1,5,5)
    #print(cochleagram2)
    #plt.imshow(np.sqrt(np.flipud(cochleagram2)))
    #plt.show()
    
    cochleagram3=get_avg(cochleagram1,11,11)
    #print(cochleagram3)
    #plt.plot(cochleagram3)
    #plt.imshow(np.sqrt(np.flipud(cochleagram3)))
    #plt.show()
    
    cochleagram4 = cochleagram_extractor(wav_data, sr, 320, 160, 64, 'triangle')
    #print(cochleagram4)
    #plt.imshow(np.sqrt(np.flipud(cochleagram4)))
    #plt.show()
    MRCG=np.hstack((cochleagram1,cochleagram2,cochleagram3,cochleagram4))
    return MRCG
'''
if __name__ == '__main__':
    wav_data = read_sphere_wav(u'C:/Users/gao/vad/863_IBM_train/F17A6.WAV')
    sr = 16000
    wav_data=MRCG(wav_data,sr)
    print(wav_data)
