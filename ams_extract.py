...
def ams_extractor(x, sr, win_len, shift_len, order):
    ...
    ams_feature = np.zeros(shape=(135, frames+3))
    wts = cal_triangle_window(0, sr//2, win_len, 135, 15.6, 400)
...
if __name__ == '__main__':
    sr, wav_data = wavfile.read('C:/Users/gao/vad/863_IBM_train/F17A6.WAV')
    ams_feature = ams_extractor(wav_data, sr, int(sr*0.032), int(sr*0.016), 1)
    print(ams_feature.shape)
